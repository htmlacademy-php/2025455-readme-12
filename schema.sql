...
ALTER TABLE posts
ADD CONSTRAINT FK_content_types_posts
...
ADD CONSTRAINT FK_posts_posts_hashtags
FOREIGN KEY (post_id) REFERENCES posts(id);
ALTER TABLE posts_hashtags
ADD CONSTRAINT FK_hashtags_posts_hashtags
...
ADD CONSTRAINT FK_users_subscriptions_author
FOREIGN KEY (author_user_id) REFERENCES users(id);
ALTER TABLE subscriptions
ADD CONSTRAINT FK_users_subscriptions_subscribed
...
ALTER TABLE messages
ADD CONSTRAINT FK_users_messages_recipient
